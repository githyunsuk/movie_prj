...
<%
/* 이 jsp는 예로, C:\eGovFrame-4.2.0\workspace.edu\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\movie_prj\common\userProfiles */
/* 이렇게 내 이클립스 웤스페이스에 저장하고 있어.  */
//멤버객체
...
// webapp/common/userProfiles 폴더에 저장
